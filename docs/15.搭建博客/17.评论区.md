...
　　‍ArtTalk：可以参考：[Vuepress配置评论插件为Artalk | 二丫讲梵](https://wiki.eryajf.net/pages/b74c2b/#%E5%89%8D%E8%A8%80)

　　‍
　　‍由于本文采用的是Twikoo，因此着重讲下怎么配置。
## Twikoo的安装
...
　　注意不要购买套餐，非常贵，最少都是4k大洋的，180w条，大部分网站用不着这么多
...
　　注意，并不会显示IP，而是显示省份，有些人会误以为后面显示的是IP，其实是浏览器版本：
...
　　‍注意事项：目前发现如果标题中带有Twikoo，则该博客底部的评论区会样式出现问题，这是因为是在加载评论区的时候，用了JS的getElementById的方法，导致样式出现问题，因此本文的标题中并没有Twikoo（而是“Twikoo的安装”）
