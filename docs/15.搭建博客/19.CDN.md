...
　　​![image](https://image.peterjxl.com/blog/image-20230219180334-6ixcesr.png)​

　　我这里已经配置好了，这里简单说明下配置过程，点击添加域名，会出下面的表单：

　　​![image](https://image.peterjxl.com/blog/image-20230219180412-5vg3z9q.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219194450-oznqc17.png)
...
　　​![image](https://image.peterjxl.com/blog/image-20230219194554-mma55qq.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219194855-n7knlwo.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219203850-skhelh3.png)​

　　‍

　　然后点击API Explorer

　　​![image](https://image.peterjxl.com/blog/image-20230219204852-o3ofzi0.png)​

　　‍

　　填上我们的加速域名（例如https://www.peterjxl.com/，注意最后有个斜线/），就可以调用接口进行测试了

　　​![image](https://image.peterjxl.com/blog/image-20230219213039-kv2yz4n.png)​

　　可以看到响应体里有任务ID，有的话一般就是正常的（如果有错误会返回），也可以在控制台里查看调用的历史和是否成功：

　　​![image](https://image.peterjxl.com/blog/image-20230219213133-oxgr38k.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219213212-fali80v.png)​

　　‍

　　查看依赖信息：

　　​![image](https://image.peterjxl.com/blog/image-20230219213232-8a4ef3x.png)​

　　‍

　　这里可以看到是使用了Maven（其他语言就不演示了）

　　​![image](https://image.peterjxl.com/blog/image-20230219213225-4d8cskn.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219213352-8nv22cn.png)​

　　‍

　　点击添加密钥，就可以下载密钥文件，包含AK/SK（Access Key ID/Secret Access Key）

　　​![image](https://image.peterjxl.com/blog/image-20230219205058-tj2lyz3.png)​
...
　　​![image](https://image.peterjxl.com/blog/image-20230219194635-g0gqu7w.png)​

　　‍

　　这里要上传下证书的公钥

　　​![image](https://image.peterjxl.com/blog/image-20230219194806-l02qc28.png)

　　‍

　　注意回源方式选择协议跟随

　　​![image](https://image.peterjxl.com/blog/image-20230219223845-pb9o1lh.png)​
