...
* [Markdown 文件图片自动上传七牛云并更新文件](https://blog.csdn.net/docdocadmin/article/details/104388487)：博主目前在用的，直接在 Markdown 文件上右键--upload 即可，非常方便，为此我还特地 fork 项目并加了一些说明，[Peter-JXL/foureggs](https://github.com/Peter-JXL/foureggs)
* [markdown-img-icexmoon · PyPI](https://pypi.org/project/markdown-img-icexmoon/0.1.8/)：文档齐全，一个 Python 包，暂未使用过
...
* [img-go: Markdown 图片辅助工具](https://gitee.com/InCerryGit/img-go) ：功能齐全，看上去很不错。
...
感兴趣的同学可以看看这篇博客：[实现全站图片使用avif格式，替代臃肿的webp教程 | 张洪Heo](https://blog.zhheo.com/p/6a933575.html)
