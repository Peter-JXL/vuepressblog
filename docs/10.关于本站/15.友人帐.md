...
- name: Manchan's Blog #名称
  desc: まん酱の记事与随笔 #描述
  avatar: https://gcore.jsdelivr.net/gh/manchan4869/Gridea/images/avatar.png #头像
  link: https://blog.manchan.top/ #链接
  bgColor: '#FFE5B4' #背景颜色-可选
  textColor: '#A05F2C' #文字颜色-可选
