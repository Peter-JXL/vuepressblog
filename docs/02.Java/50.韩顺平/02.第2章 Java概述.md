...
　　![image](https://image.peterjxl.com/blog/image-20221113184524-fh08b0g.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221113185042-9anqnqt.png)
...
3. Java语言是跨平台​性的。【即：一个编译好的class文件，可以在多个系统下运行，这种特性叫做跨平台性】。例如刚刚我们编写了一个文件Test.java，我们编译后会得到class文件，这个文件可以在Windows、Mac电脑和Linux电脑（Linux也是一种操作系统，和Windows一样）上运行。我们不需要对这个文件重新编译，怎么做到的？用了Java虚拟机，我们后面会讲。
    ...
    ![image](https://image.peterjxl.com/blog/image-20221113191331-dbntlzh.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221112215847-hxpkanq.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221113193245-81obkfi.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221113201050-v8tlcn7.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221113201025-dk6jtz6.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221113202350-qkm7sf1.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221114102301-cot5zs9.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221114104948-qelh7u4.png)​
...
　　![image](https://image.peterjxl.com/blog/image-20221114105118-pfgi3l9.png)​
